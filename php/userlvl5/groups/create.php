<?php
    ...
    $HostPath = "..";
    if((isset($_POST['Name']) and isset($_POST['Description'])) and ($_POST['Name'] != "" and $_POST['Description'] != ""))
    {
        $Group = new Group;
        $Group->name = $_POST['Name'];      
        $Group->description = $_POST['Description'];  
        $Result = GroupCreate($Group);
        print($Result);        
    }
?>
      ...
      <div class="row align-items-center">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputGroupName" placeholder="Group name here..." name="Name">

                <label for="InputGroupDescription">Description</label>
                <textarea rows="5" type="input" class="form-control" id="InputGroupDescription" placeholder="Group description here..." name="Description" required></textarea>
