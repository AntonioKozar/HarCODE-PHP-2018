<?php
    ...
    {
        $ID = $_POST['ID'];    
        $Result = GroupDelete($ID);
        header("Location:" . $HostPath . "/groups/index.php");
    }
    elseif (isset($_POST['ID']) and $_POST['ID'] != "") {
        ...
        if($Result == 0)
        {
            $Result = '<script>alert("GroupDelete you are trying to delete is missing. Contact your administrator.");</script>';
            print($Result);
            header("Location:" . $HostPath . "/groups/index.php");
        }
        ...
        $Result = '<script>alert("You need to select GroupDelete to delete it.");</script>';
        print($Result);
        header("Location:" . $HostPath . "/groups/index.php");
    }    
?>
      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownGroups">
                  ...
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/groups/delete.php">Delete</a>
                </div>
              </li>
              <li class="nav-item dropdown">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input value="<?php print($Result['name']);?>" type="input" class="form-control" id="InputGroupName" placeholder="Group name here..." name="Name" disabled>

                <label for="InputGroupDescription">Description</label>
                <textarea rows="5" type="input" class="form-control" id="InputGroupDescription" placeholder="Group description here..." name="Description" required disabled>
                <?php print(trim($Result['description']));?>
                </textarea>
