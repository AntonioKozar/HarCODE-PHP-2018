<?php
    ...
    elseif (isset($_POST['ID']) and $_POST['ID'] != "") {
        ...
        if($Result == 0)
        {
            $Result = '<script>alert("Group you are trying to edit is missing. Contact your administrator.");</script>';
            print($Result);
            header("Location:" . $HostPath . "/groups/index.php");
        }
    }
    else{
        $Result = '<script>alert("You need to select group to edit it.");</script>';
        print($Result);
        header("Location:" . $HostPath . "/groups/index.php");
    }    
?>
      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownGroups">
                  ...
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/groups/update.php">Update</a>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input value="<?php print($Result['name']);?>" type="input" class="form-control" id="InputGroupName" placeholder="Group name here..." name="Name">

                <label for="InputGroupDescription">Description</label>
                <textarea rows="5" type="input" class="form-control" id="InputGroupDescription" placeholder="Group description here..." name="Description" required>
