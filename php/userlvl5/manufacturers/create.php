<?php
    ...
    if(isset($_POST['Save']) and $_POST['Save'] == "1" )
    {
        ...
        $Result = ManufacturerCreate($Manufacturer);
        print($Result);        
    }
    $CityResult = CityView();
?>
      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownManufacturers">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/manufacturers/create.php">Create</a>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputManufacturerName" placeholder="Manufacturer name here..." name="Name" required>

                <label for="InputManufacturerDescription">Description</label>
                <textarea rows="5" type="input" class="form-control" id="InputManufacturerDescription" placeholder="Manufacturer description here..." name="Description" required></textarea>

                <label for="InputManufacturerAdress">Adress</label>
                <input type="input" class="form-control" id="InputManufacturerAdress" placeholder="Manufacturer adress here..." name="Adress" required>

                <label for="InputManufacturerTelephone">Telephone</label>
                <input type="tel" class="form-control" id="InputManufacturerTelephone" placeholder="Manufacturer telephone number here..." name="Telephone" required>

                <label for="InputManufacturerEmail">Email</label>
                <input type="email" class="form-control" id="InputManufacturerEmail" placeholder="Manufacturer email here..." name="Email" required>

                <label for="InputManufacturerURL">URL</label>
                <input type="url" class="form-control" id="InputManufacturerURL" placeholder="Manufacturer URL here..." name="URL" required>
