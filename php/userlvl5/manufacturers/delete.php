      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownManufacturers">
                  ...
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/manufacturers/delete.php">Delete</a>
                </div>
              </li>
              <li class="nav-item dropdown">
        ...
        <form method="POST">
            ...
            <label for="InputManufacturerName">Name</label>
                <input disabled value="<?php print($Result['name']); ?>" type="input" class="form-control" id="InputManufacturerName" placeholder="Manufacturer name here..." name="Name" required>

                <label for="InputManufacturerDescription">Description</label>
                <textarea disabled rows="5" type="input" class="form-control" id="InputManufacturerDescription" placeholder="Manufacturer description here..." name="Description" required>
                <?php print($Result['description']);?>
                </textarea>

                <label for="InputManufacturerAdress">Adress</label>
                <input disabled value="<?php print($Result['adress']);?>" type="input" class="form-control" id="InputManufacturerAdress" placeholder="Manufacturer adress here..." name="Adress" required>

                <label for="InputManufacturerTelephone">Telephone</label>
                <input disabled value="<?php print($Result['telephone']);?>" type="tel" class="form-control" id="InputManufacturerTelephone" placeholder="Manufacturer telephone number here..." name="Telephone" required>

                <label for="InputManufacturerEmail">Email</label>
                <input disabled value="<?php print($Result['email']);?>" type="email" class="form-control" id="InputManufacturerEmail" placeholder="Manufacturer email here..." name="Email" required>

                <label for="InputManufacturerURL">URL</label>
                <input disabled value="<?php print($Result['url']);?>" type="url" class="form-control" id="InputManufacturerURL" placeholder="Manufacturer URL here..." name="URL" required>

                <label for="InputManufacturerCity">City</label>
                <select disabled class="form-control" id="InputManufacturerCity" name="City" required>
