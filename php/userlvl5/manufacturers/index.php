      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownManufacturers">
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/manufacturers/index.php">View</a>
                  <div class="dropdown-divider"></div>
        ...
        <table class="table table-hover table-sm">
            ...
            ?>
                ...
                <td><a target="_blank" class="btn btn-sm btn-link" href="<?php print($Row[6]);?>">LINK</a></td>
                <td><?php print($Row[7]);?></td>
                <td>
                    <div class="btn-group" role="group">
                        <form method="POST" action="update.php">
                            <input type="hidden" class="form-control" id="CityID" name="ID" value="<?php print($Row[0]);?>">
