      ...
      <div class="row align-items-center">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputCityName" placeholder="City name here..." name="Name" value="<?php print($Result['name']);?>" disabled>

                <label for="InputCityZipcode">Zipcode</label>
                <input type="input" class="form-control" id="InputCityZipcode" placeholder="City zip code here..." name="Zipcode" value="<?php print($Result['zipcode']);?>" disabled>

                <label for="InputCountryName">Country</label>
                <select class="form-control disabled" id="InputCountryName" name="Country" disabled>
