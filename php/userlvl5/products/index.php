            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownProducts">
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/products/index.php">View</a>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <form method="POST" action="read.php">
                            <input type="hidden" class="form-control" id="ProductID" name="ID" value="<?php print($Row[0]);?>">
                            <button type="submit" class="btn btn-light btn-sm">More info</button>
                        </form> 
