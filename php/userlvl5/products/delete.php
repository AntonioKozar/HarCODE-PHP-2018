<?php
    ...
    if(isset($_POST['delete']) and $_POST['delete'] == "1")
    {
        ...
        $Result = ProductsDelete($Products);
    ...
    elseif (isset($_POST['ID']) and $_POST['ID'] != "") {
        ...
        if($Result == 0)
        {
            $Result = '<script>alert("Product you are trying to delete is missing. Contact your administrator.");</script>';
            print($Result);
            header("Location:" . $HostPath . "/products/index.php");
        }
        $GroupView = GroupView();
        ...
        $Result = '<script>alert("You need to select product to delete it.");</script>';
        print($Result);
        header("Location:" . $HostPath . "/products/index.php");
    } 
    ...
    <div class="container">
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownProducts">
                  ...
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/products/delete.php">Delete</a>
                </div>
              </li>
        ...
        <div class="form-group">
                ...
                <input disabled value="<?php print($Result['harcode']);?>" type="input" class="form-control" id="InputProductsHarcode" placeholder="Product harcode here..." name="Harcode" required maxlength="7">

                <label for="InputProductsBarcode">Barcode</label>
                <input disabled value="<?php print($Result['barcode']);?>" type="input" class="form-control" id="InputProductsBarcode" placeholder="Product barcode here..." name="Barcode" required maxlength="13">

                <label for="InputProductsTitle">Title</label>
                <input disabled value="<?php print($Result['title']);?>" type="input" class="form-control" id="InputProductsTitle" placeholder="Product title here..." name="Title" required maxlength="128">

                <label for="InputProductsSubtitle">Subtitle</label>
                <input disabled value="<?php print($Result['subtitle']);?>" type="input" class="form-control" id="InputProductsSubtitle" placeholder="Product subtitle here..." name="Subtitle" required maxlength="256">

                <label for="InputProductsDescription">Description</label>
                <textarea disabled rows="5" type="input" class="form-control" id="InputProductsDescription" placeholder="Product description here..." name="Description" required>
                <?php print($Result['description']);?>
                </textarea>

                <label for="InputProductsInformation">Information</label>
                <input disabled value="<?php print($Result['information']);?>" type="input" class="form-control" id="InputProductsInformation" placeholder="Product information here..." name="Information" required>

                <label for="InputProductsAudio">Audio</label>
                <br>
                <audio controls>
                ...
                <br>
                <label for="InputProductsVideo">Video</label>
                <br>
                <iframe width="420" height="315"
                    src="<?php print($Result["video"]);?>">
                </iframe>
                <input disabled value="<?php print($Result['video']);?>" type="hidden" class="form-control btn btn-light btn-sm" id="InputProductsAudio" name="Video" required>
                <br>
                <label for="InputProductsPFDNEW">PDF</label>
                <a disabled target="_blank" class="form-control btn btn-light btn-sm" href="<?php print($Result["pdf"]);?>">PDF</a>
                ...
                <select disabled class="form-control" id="InputProductsGroup" name="Group" required>
                ...
                <select disabled class="form-control" id="InputProductsSubgroup" name="Subgroup" required>
            ...
            <input type="hidden" class="form-control" id="ProductsID" name="ID" value="<?php print($ID);?>">
