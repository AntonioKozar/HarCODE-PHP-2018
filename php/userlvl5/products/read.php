<?php
    ...
    if (isset($_POST['ID']) and $_POST['ID'] != "") {
        ...
        if($Result == 0)
        {
            $Result = '<script>alert("Product you are trying to view is missing. Contact your administrator.");</script>';
            print($Result);
      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownProducts">
                  ...
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/products/read.php">Read</a>                  
        ...
        <table class="table table-hover table-sm">
            <tbody>
                ...
                <td><?php print($Result["harcode"]);?></td>
                </tr>
                <tr>
                <th scope="col">Barcode</th>
                <td><?php print($Result["barcode"]);?></td>
                </tr>
                <tr>
                ...
                <td><?php print($Result["subtitle"]);?></td>
                </tr>
                <tr>
                ...
                <td><?php print($Result["information"]);?></td>
                </tr>
                <tr>
                ...
                <tr>
                <th scope="col">PDF</th>
                <td><a target="_blank" class="btn btn-sm btn-link" href="<?php print($Result["pdf"]);?>">PDF</a></td>
                </tr>
                <tr>
                <th scope="col">Group</th>
                <td><?php print($Result["groups"]);?></td>
                </tr>
                <tr>
                <th scope="col">Subgroup</th>
                <td><?php print($Result["subgroups"]);?></td>
                </tr>
            </tbody>                        
        </table>
        <br><br><hr><br>
