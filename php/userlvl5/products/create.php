      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownProducts">
                  ...
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/products/create.php">Create</a>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputProductsHarcode" placeholder="Product harcode here..." name="Harcode" required maxlength="7">

                <label for="InputProductsBarcode">Barcode</label>
                <input type="input" class="form-control" id="InputProductsBarcode" placeholder="Product barcode here..." name="Barcode" required maxlength="13">

                <label for="InputProductsTitle">Title</label>
                <input type="input" class="form-control" id="InputProductsTitle" placeholder="Product title here..." name="Title" required maxlength="128">

                <label for="InputProductsSubtitle">Subtitle</label>
                <input type="input" class="form-control" id="InputProductsSubtitle" placeholder="Product subtitle here..." name="Subtitle" required maxlength="256>

                <label for="InputProductsDescription">Description</label>
                <textarea rows="5" type="input" class="form-control" id="InputProductsDescription" placeholder="Product description here..." name="Description" required></textarea>

                <label for="InputProductsInformation">Information</label>
                <input type="input" class="form-control" id="InputProductsInformation" placeholder="Product information here..." name="Information" required>

                <label for="InputProductsAudio">Audio</label>
                <input type="file" class="form-control btn btn-light btn-sm" id="InputProductsAudio" name="Audio" required>
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" id="InputProductsVideo" placeholder="Product video here..." name="Video" required maxlength="64">
                </div>

                <label for="InputProductsPFD">PDF</label>
                <input type="file" class="form-control btn btn-light btn-sm" id="InputProductsPFD" name="PDF" required>
