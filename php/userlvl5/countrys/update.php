<?php
    ...
    if(isset($_POST['Name']) and isset($_POST['ID']) and ($_POST['Name'] != "" and $_POST['ID'] != ""))
    {
        $Country = new Country;
        $Country->name = $_POST['Name'];
        $ID = $_POST['ID'];    
        $Result = CountryUpdate($Country, $ID);
      ...
      <div class="row align-items-center">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputCountryName" placeholder="Country name here..." name="Name" value="<?php print($Result['name']); ?>">
            </div>
