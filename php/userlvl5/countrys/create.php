      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownCountrys">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/countrys/create.php">Create</a>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputCountryName" placeholder="Country name here..." name="Name">
            </div>
