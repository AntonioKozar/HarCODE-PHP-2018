            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownCountrys">
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/countrys/index.php">View</a>
                  <div class="dropdown-divider"></div>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <form method="POST" action="update.php">
                            <input type="hidden" class="form-control" id="CountryID" name="ID" value="<?php print($Row[0]);?>">
