<?php
    ...
    if(isset($_POST['Submit']) and $_POST['Submit'] == "1")
    {
        ...
        $Result = SubgroupCreate($SubGroup);
        print($Result);        
    }
      ...
      <div class="row align-items-center">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownSubgroups">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/subgroups/create.php">Create</a>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="input" class="form-control" id="InputSubgroupName" placeholder="Subgroup name here..." name="Name">

                <label for="InputSubgroupDescription">Description</label>
                <textarea rows="5" type="input" class="form-control" id="InputSubgroupDescription" placeholder="Subgroup description here..." name="Description" required></textarea>

                <label for="InputSubgroupGroup">Group</label>
                <select class="form-control" id="InputSubgroupGroup" name="Group">
                <?php 
