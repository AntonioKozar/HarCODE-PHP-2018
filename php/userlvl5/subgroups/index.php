            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownSubgroups">
                  <a class="dropdown-item active" href="<?php print($HostPath) ?>/subgroups/index.php">View</a>
                  <div class="dropdown-divider"></div>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <form method="POST" action="update.php">
                            <input type="hidden" class="form-control" id="GroupID" name="ID" value="<?php print($Row[0]);?>">
