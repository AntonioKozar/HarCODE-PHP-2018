    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="form-group">
                ...
                <input disabled value="<?php print($Result['name']);?>" type="input" class="form-control" id="InputSubgroupName" placeholder="Subgroup name here..." name="Name" required>

                <label for="InputSubgroupDescription">Description</label>
                <textarea disabled rows="5" type="input" class="form-control" id="InputSubgroupDescription" placeholder="Subgroup description here..." name="Description" required>
                <?php print($Result['description']);?>
                </textarea>

                <label for="InputSubgroupGroup">Group</label>
                <select disabled class="form-control" id="InputSubgroupGroup" name="Group" required>
